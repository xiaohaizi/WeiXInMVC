...
function x(t,e){
var t="/misc/appmsganalysisAction?action=all",a=J.filters,e={
...
function T(t,e){
return 0!==t.base_resp.ret?(O.show(t),e&&J.filters.pageNum--,void R()):(V=U.parseJSON(t.article_summary_data)||{
list:[]
},W=U.parseJSON(t.total_article_data).list||[],W.length<B?P():K(),k(),v(e),h(),y(),
I(),m(e),void R());
}
function k(){
W.each(function(t){
