define("statistics/user_stat/summary/summary.js", ["biz_common/moment.js", "statistics/components/tab-bar2.js", "statistics/components/date-range2.js", "statistics/components/date-range.js", "biz_web/ui/dropdown.js", "common/wx/Cgi.js", "common/wx/report_util.js", "statistics/user_stat/summary/summary-state.js", "statistics/user_stat/summary/summary-chart.js", "statistics/user_stat/common.js", "statistics/common.js", "statistics/user_stat/top.js"],
    ...
    function K(e, t, a) {
        var n = "/misc/useranalysisAction?begin_date=%s&end_date=%s&source=%s", r = n.sprintf(e, t, a);
        return r;
    }
    function A(e) {
        ...
        X(), st([s], function (r) {
            ...
            if (wt) {
                ...
                e ? (t = tt.tableBeginDate, a = tt.tableEndDate,
                tt.tableUserStateList = Y(t, a, i),
                l(t, a)) : (tt.sourceData = V(t, a, o),
                tt.userStatList = Y(t, a, i),
                tt.tableUserStateList = tt.userStatList, at.draw(),
                l(t, a)),
    ...
    function T() {
        var e = tt.beginDate, t = tt.endDate, a = wt ? tt.source + ",99999999" : tt.source,
            n = K(e, t, a),
            r = tt.beginCompareDate,
            s = tt.endCompareDate,
            i = K(r, s, a);
    ...
    function V(e, t, a) {
        ...
        for (var n = Y(e, t, a[0].list), r = 1, s = a.length; s > r; r++)
            for (var i = a[r].list, o = 0, c = i.length; c > o; o++) {
            var u = i[o];
            O(n[u.date], u);
        }
        return n;
    ...
    var J = e("biz_common/moment.js"), F = e("statistics/components/tab-bar2.js"),
        Q = e("statistics/components/date-range2.js"),
        H = e("statistics/components/date-range.js"),
        W = e("biz_web/ui/dropdown.js"), q = jQuery,
        Z = e("common/wx/Cgi.js"),
        et = e("common/wx/report_util.js"),
        tt = e("statistics/user_stat/summary/summary-state.js"),
        at = e("statistics/user_stat/summary/summary-chart.js"),
        nt = e("statistics/user_stat/common.js");
   
    var     rt = e("statistics/common.js"),
     
        st = (nt.log, nt.mGet),
        it = nt.loopDay, ot = e("statistics/user_stat/top.js");
