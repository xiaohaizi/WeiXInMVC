...
e("common/wx/media/multipleAppmsg.js"),e("message/message_cgi.js")),g=e("common/wx/tooltips.js"),h=e("common/wx/Cgi.js"),f=(e("biz_common/moment.js"),
...
s.id=1e5*Math.random()|0,e.append(wx.T(f,s));
},
17:function(e,t){
...
for(var z=$(".mass_opr"),k=0;w>k;++k)1==v[k].can_retry_masssend&&5==v[k].msg_status&&(z.eq(k).find(".js_desc").after('<a class="js_resend" href="javascript:void(0);">补发</a>'),
z.eq(k).find(".js_resend").attr("data-id",v[k].id));
...
var j=e("biz_common/utils/wxgspeedsdk.js");
j.setBasicTime({
