define("statistics/article/analyse/main.js", ["statistics/article/top.js", "statistics/chart/empty-pie.js", "statistics/article/analyse/click-report.js", "statistics/components/tab-bar2.js", "statistics/components/date-range2.js", "statistics/components/table-date.js", "statistics/components/misc-date.js", "statistics/chart/pie.js", "statistics/common.js", "statistics/tooltip.js", "biz_web/ui/dropdown.js", "biz_common/moment.js", "common/wx/Cgi.js", "common/wx/report_util.js", "statistics/common_util.js"], function (e) {
    ...
    function s() {
        N = new R, $("#js_date_range").html(N.$el), N.init(), N.on("date-change", function (e) {
            ...
            q = !0, h(), nt.is_compare ? (x(), Q.hide()) : (w(), Q.show(), Q.setDate(e), d());
        });
    }
    function n(e) {
        ct = rt = {};
    ...
    function p() {
        ...
        }), jQuery("#js_filter_source").html(S.$el),
        S.on("tab-selected", function (e, t) {
    ...
    function g(e, t) {
        ...
        nt.indexText = [a + "人数", a + "次数"]), "int_page_read" == s ? m() : l(), h() && v(), nt.is_compare ? D() : j();
    }
    function h() {
        return f() ? (y(), !1) : (b(), !0);
    }
    ...
    function w() {
        if (!_t) {
            ...
            e = "&begin_date=%s&end_date=%s".sprintf(a, s), O("load mssage data"), F.get({
                url: "/misc/appmsganalysisaction_report?action=report&type=%s%s".sprintf(nt.type, e),
                success: function (e) {
                    var a = Y("load mssage data");
                    I(z, a, K), 0 == e.base_resp.ret ? (t(e.item), dt = e.share_item, j(), nt.isTableDateChange || v(),
                    nt.isTableDateChange = !1) : F.show(e);
                },
                complete: function () {
                    _t = !1, U.hideLoading();
                }
    ...
    var E = e("statistics/article/analyse/click-report.js"), A = e("statistics/components/tab-bar2.js"), L = (e("statistics/components/date-range2.js"),
    e("statistics/components/table-date.js")), R = e("statistics/components/misc-date.js"), k = e("statistics/chart/pie.js"), B = e("statistics/common.js"), z = B.reportKeys.LOAD_ARTICLE_DATA_AJAX_KEY, I = B.ajaxReport, O = B.time, Y = B.timeEnd, K = wx.data.uin, M = null, H = null, N = null, Q = null, S = null;
    ...
    v(), j(), E.init(), seajs.use("statistics/report.js", function (e) {
