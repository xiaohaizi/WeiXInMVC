...
function t(){
var e=null,t={
wxverify:wx.url("/merchant/store?action=detail&t=wxverify/detail&info=verify"),
...
function i(){
var e=null,t=template.render,a=_.user_api_info,o=_.jsapi_info,s={};
$.each(a.api_group,function(e,t){
var a=t.group_name;
s[a]=t.api_quota_list,$.each(t.api_quota_list.api_quota,function(e,t){
var o="%s_%s".sprintf(a,t.api_name);
parseInt(t.used_quota)>parseInt(t.quota)&&(t.used_quota=t.quota),s[o]=t.used_quota+"/"+t.quota;
});
}),$.each(o.jsapi_info_list,function(e,t){
var a=t.jsapi_name.replace(/:/g,"_");
s[a]=t.state;
}),$("#js_api").html(t("tpl_api",s)),console.log(s),console.log(s.snsapi_userinfo),
$("table").on("mouseover",".js_api_detail",function(){
$(this);
e&&e.remove(),e=new d({
dom:this,
content:t($(this).data("id"),s),
margin:"right",
className:"right_pop",
hover:!0
}),e.$pop.offset({
...
s.go(2),$(".js_apply_step1").hide(),$(".js_apply_step2").show();
}),$(".js_apply_prev").click(function(){
s.go(1),$(".js_apply_step1").show(),$(".js_apply_step2").hide();
});
var o=$(".js_reason"),n=new h(o,{
maxLength:30
});
$(".js_apply_submit").click(function(){
var s=n.getCount(),i=$(".js_apply_reason_tip");
0==s?(i.text("请填写申请理由"),o.focus()):s>30?(i.text("申请理由不能超过30字"),o.focus()):(i.text(""),
l.post({
...
var e=$(".js_reset");
e.each(function(){
var e=.6,a=$(this),o=a.data("name"),n=[],i={
action:"del_api_quota"
},c=!1;
a.data("group")?($("<div></div>").html(t(a.data("group"),s)).find(".js_quota").each(function(){
n.push($(this).text());
}),i.api_group=o):(n.push(a.data("quota")),i.api=o),$.each(n,function(t,a){
var o=a.split("/");
